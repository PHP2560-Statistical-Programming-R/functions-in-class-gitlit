...
The t test has n-1 degrees of freedom , which is similar to this problem. In the t test we calculate estimates for the standard error hence the n-1 df.You have decreased the sample size by 1 when you omit an obesrvation and so this accounts for that.
